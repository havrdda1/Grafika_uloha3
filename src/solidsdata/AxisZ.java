...
public class AxisZ implements Solid<Point3D,Topology> {
...
public AxisZ() {
        parts = Array.of(new Part(0,1,Topology.LINES));
        vertices = Array.of(new Point3D(0,0,0),
        new Point3D(0,0,4));
        indices = Stream.rangeClosed(0,0).flatMap(i->Array.of(i,i+1)).toArray();
        }
